...
When adding features, prefer enhancing existing tools (optional params) over new tools. Each MCP tool costs ~100 tokens/turn in system prompt. ROI: (frequency × savings) - (turns × overhead).
