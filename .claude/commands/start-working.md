...
| Ready | `complexity:low` or `complexity:medium` with acceptance criteria in the body; prioritize `V1` milestone over `V2`/`V3` |
...
| P2 | Normal | `complexity:high` issues with acceptance criteria, `from-audit` issues, `V2`/`V3` milestone items |
