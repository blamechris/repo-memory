...
# This repo has no verified label taxonomy — `complexity:<level>` is a placeholder shape; verify it exists before applying.
...
<!-- skill-templates: create-issue 12b011f 2026-06-08 -->
