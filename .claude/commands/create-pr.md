...
5. **Cache correctness implications** (if touching cache/hash logic, note any invalidation or determinism concerns)
...
8. **Cache correctness** — When changes touch cache/hash logic, flag any implications for invalidation or determinism in the confirmation step.
